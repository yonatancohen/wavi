...
**Layer 1 — Structured DB** *(always included, fast Postgres queries)*
...
**Layer 2 — Vector Store / RAG** *(retrieved per request via pgvector)*
...
**Layer 3 — Compressed Summaries** *(pre-computed, always included)*
...
- High humor example: *"Ok ok, that one didn't land. I'll retire that joke. Probably."*
- Low humor example: *"That was off — sorry. Let me try again."*
- Original reply flagged as **Miss** in dashboard
- Owner can add note: what went wrong, to improve future prompts

### F-08 — Scheduled Posts *(owner-activated)*
...
*Estimate: 5 groups · ~30 agent replies/day · 1,000 new messages/day*
